  ...
  <div class="info">
    ...
    <el-card class="box-card-info" shadow="hover">
      ...
      <div>
        ...
        <li>
          予想獲得ファン数の値は「<b>出走レースに全て勝利した場合のファン数期待値</b>」です。ファン数ボーナスは純粋にボーナス割合を加算する計算としています。実際には獲得ファン数はある程度ランダムであり、出走レース全てで1着を取った場合でも実際のファン数とは一定のずれが生じます。
        </li>
        <li>
          出走レースに勝利できなかった場合など、プランが全て順調に遂行できない場合があるため、ノルマ達成計画に一定の「余裕」を設定することができます。
        </li>
        <li>
    ...
    <el-card class="box-card-info" shadow="hover">
      ...
      <div>
        ...
        <li>
          レース計画機能において、オグリキャップ・スマートファルコンの「○回1着」目標に対応していません(今後実装予定)。
        </li>
        <li>
