  ...
  <div class="info">
    ...
    <el-card class="box-card-info" shadow="hover">
      ...
      <div>
        ...
        <li>
          多少のレスポンシブに対応しています。ただし特にスマートフォンの場合は動作が重い場合があります。
        </li>
      </div>
    </el-card>
    <el-card class="box-card-info" shadow="hover">
    ...
    <el-card class="box-card-info" shadow="hover">
      ...
      <div>
        ...
        <li>
          レスポンシブにある程度対応していますが、サイト全体の動作が重い為、現状ではPCまたはタブレット端末からの閲覧を推奨します。
        </li>
        <li>
          既知の不具合として、ハンバーガーメニューを開いた状態でウィンドウ幅を大きく広げたり縮めたりするとハンバーガーメニューの表示が反転してしまいます(修正検討中)。
        </li>
        <li>
